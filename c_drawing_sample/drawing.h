...
void display_draw();
void draw_change_color(unsigned char, unsigned char, unsigned char);
void turn(int,int);
void draw(int);
void move(int, int);
...
void _draw_change_color(struct _drawing *,unsigned char, unsigned char, unsigned char);
void _push(struct _coordinate_lst **, struct _coordinate, struct RGB);
void _turn(struct _drawing *, int, int);
void _display_draw(struct _drawing, struct _coordinate_lst *);
